...
# create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
numbers = [int(number) for number in numbers if number > 9]
print(numbers)
...
last_name = ", ".join([name.split()[-1] for name in full_names if len(name) > 11])
print(last_name)
